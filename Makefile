#############################################################################
# Makefile for building: echo_client_server
# Generated by qmake (3.1) (Qt 5.15.15)
# Project:  echo_client_server.pro
# Template: subdirs
# Command: /usr/lib/qt5/bin/qmake -o Makefile echo_client_server.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = echo_client_server1.0.0
DISTDIR = /home/kali/gilgil/echo_client_server/.tmp/echo_client_server1.0.0
SUBTARGETS    =  \
		sub-ec \
		sub-es


sub-ec-qmake_all:  FORCE
	@test -d ec/ || mkdir -p ec/
	cd ec/ && $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/ec/ec.pro
	cd ec/ && $(MAKE) -f Makefile qmake_all
sub-ec: FORCE
	@test -d ec/ || mkdir -p ec/
	cd ec/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/ec/ec.pro ) && $(MAKE) -f Makefile
sub-ec-make_first: FORCE
	@test -d ec/ || mkdir -p ec/
	cd ec/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/ec/ec.pro ) && $(MAKE) -f Makefile 
sub-ec-all: FORCE
	@test -d ec/ || mkdir -p ec/
	cd ec/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/ec/ec.pro ) && $(MAKE) -f Makefile all
sub-ec-clean: FORCE
	@test -d ec/ || mkdir -p ec/
	cd ec/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/ec/ec.pro ) && $(MAKE) -f Makefile clean
sub-ec-distclean: FORCE
	@test -d ec/ || mkdir -p ec/
	cd ec/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/ec/ec.pro ) && $(MAKE) -f Makefile distclean
sub-ec-install_subtargets: FORCE
	@test -d ec/ || mkdir -p ec/
	cd ec/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/ec/ec.pro ) && $(MAKE) -f Makefile install
sub-ec-uninstall_subtargets: FORCE
	@test -d ec/ || mkdir -p ec/
	cd ec/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/ec/ec.pro ) && $(MAKE) -f Makefile uninstall
sub-es-qmake_all:  FORCE
	@test -d es/ || mkdir -p es/
	cd es/ && $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/es/es.pro
	cd es/ && $(MAKE) -f Makefile qmake_all
sub-es: FORCE
	@test -d es/ || mkdir -p es/
	cd es/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/es/es.pro ) && $(MAKE) -f Makefile
sub-es-make_first: FORCE
	@test -d es/ || mkdir -p es/
	cd es/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/es/es.pro ) && $(MAKE) -f Makefile 
sub-es-all: FORCE
	@test -d es/ || mkdir -p es/
	cd es/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/es/es.pro ) && $(MAKE) -f Makefile all
sub-es-clean: FORCE
	@test -d es/ || mkdir -p es/
	cd es/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/es/es.pro ) && $(MAKE) -f Makefile clean
sub-es-distclean: FORCE
	@test -d es/ || mkdir -p es/
	cd es/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/es/es.pro ) && $(MAKE) -f Makefile distclean
sub-es-install_subtargets: FORCE
	@test -d es/ || mkdir -p es/
	cd es/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/es/es.pro ) && $(MAKE) -f Makefile install
sub-es-uninstall_subtargets: FORCE
	@test -d es/ || mkdir -p es/
	cd es/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/es/es.pro ) && $(MAKE) -f Makefile uninstall

Makefile: echo_client_server.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		echo_client_server.pro
	$(QMAKE) -o Makefile echo_client_server.pro
...
qmake_all: sub-ec-qmake_all sub-es-qmake_all FORCE

make_first: sub-ec-make_first sub-es-make_first  FORCE
all: sub-ec-all sub-es-all  FORCE
clean: sub-ec-clean sub-es-clean  FORCE
distclean: sub-ec-distclean sub-es-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) .qmake.stash
install_subtargets: sub-ec-install_subtargets sub-es-install_subtargets FORCE
uninstall_subtargets: sub-ec-uninstall_subtargets sub-es-uninstall_subtargets FORCE

sub-ec-check:
	@test -d ec/ || mkdir -p ec/
	cd ec/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/ec/ec.pro ) && $(MAKE) -f Makefile check
sub-es-check:
	@test -d es/ || mkdir -p es/
	cd es/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/es/es.pro ) && $(MAKE) -f Makefile check
check: sub-ec-check sub-es-check

sub-ec-benchmark:
	@test -d ec/ || mkdir -p ec/
	cd ec/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/ec/ec.pro ) && $(MAKE) -f Makefile benchmark
sub-es-benchmark:
	@test -d es/ || mkdir -p es/
	cd es/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/kali/gilgil/echo_client_server/es/es.pro ) && $(MAKE) -f Makefile benchmark
benchmark: sub-ec-benchmark sub-es-benchmark
